...
export default class Card extends React.Component {
    ...
    UpdatedatarootMisu=() => {
        ...
        firebase.database().ref('ข้อมูล/'+Class).update({
            Class,
          BTUname,
          pirename,
          Day,
...
<TouchableHighlight style={[styles.buttonContainer,styles.Btn]}
                 onPress= {this.UpdatedatarootMisu.bind(this)}>
                            <View style={styles.inputContainer2}>
       ...
       <TouchableHighlight style={[styles.buttonContainer,styles.Btn]}
                 onPress= {this.onReadUserDataButtonPressMisu.bind(this)}>
                            <View style={styles.inputContainer2}>
